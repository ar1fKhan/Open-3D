...
Although the Open3D project was started by `Qianyi Zhou` and `Jaesik Park`, it is now developed and maintained by the Open3D community and any future contributor is highly welcomed.
